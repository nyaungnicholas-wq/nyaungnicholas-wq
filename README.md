...
More on the site → **[nicholasnyaung.com](https://nicholasnyaung.com)**

---

### ⚙️ How I work
Idea → deployed product, solo, at studio speed. I care about shipping real things people can click, honest scope, and clean code.

### 🧰 Stack
`TypeScript` `Next.js / React` `Node` `Python` `Tailwind` `Postgres` `Vercel`
